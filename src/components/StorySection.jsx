      ...
      >
        <div ref={textRef} className="max-w-3xl text-center">
          <p className="text-lg md:text-3xl font-bold leading-relaxed uppercase tracking-wide">
            IRINA MOVED TO THE UK OVER 26 YEARS AGO WITH NO ENGLISH. SHE KNOWS
            FIRST-HAND HOW CONFUSING, FRUSTRATING, AND OVERWHELMING IT CAN FEEL
            TO COMMUNICATE IN A NEW LANGUAGE. THAT EXPERIENCE SHAPED THE WAY SHE
            TEACHES TODAY — PRACTICAL, SUPPORTIVE, AND FOCUSED ON WHAT ACTUALLY
            HELPS PEOPLE FEEL CONFIDENT AND UNDERSTOOD. TODAY, AS THE FOUNDER OF
            PROLINGUAL HUB LTD, IRINA HELPS NON-NATIVE PROFESSIONALS BUILD
            REAL-WORLD ENGLISH SKILLS THROUGH A HUMAN, SENSORY-LED APPROACH THAT
            MAKES LEARNING FEEL NATURAL AND ACHIEVABLE.
          </p>
        </div>
      </div>
    </div>
