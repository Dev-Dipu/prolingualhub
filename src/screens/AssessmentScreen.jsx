      ...
      try {
        ...
        if (response.success) {
          ...
          response.data.forEach((question, index) => {
            ...
            // Add question with transformed structure
            transformedData[category].questions.push({
              id: index + 1,
              type: "multiple-choice", // Assume all are multiple choice for now
          ...
          console.error("Failed to load assessment data:", response.error);
        }
      } catch (error) {
